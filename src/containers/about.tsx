...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="relative">
      ...
      <article
        className="relative max-w-[50rem] mx-auto bg-background/90% border rounded-lg p-6 flex
      flex-col gap-y-6"
      >
        <Effect
          variant="square"
        ...
        />
        <p className="text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum accusantium officiis a,
          magnam amet doloribus perspiciatis minus veritatis quidem facere eligendi quibusdam itaque molestiae perferendis ad corporis,
          incidunt nulla quas?
        </p>
